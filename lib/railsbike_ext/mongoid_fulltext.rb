require 'railsbike_ext/mongoid_indexes'
...
module Mongoid::FullTextSearch
  ...
  module ClassMethods
    ...
    def fulltext_search(query_string, options={})
      ...
      coll = _parent.collection.db.collection(index_name)
    ...
    def all_ngrams(str, config, bound_number_returned = true)
      ...
      filtered_str = str.downcase.split('').compact.join('')
    ...
    def update_ngram_index
      self._parent.contents.each do |model|
