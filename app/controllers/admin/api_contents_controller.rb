      ...
      respond_to do |format|
        if @content.save
          ...
          format.html do
            ...
            #back_url = params[:success_callback].blank? ? :back : params[:success_callback]
            redirect_to params[:success_callback].blank? ? :back : params[:success_callback]
          end
        else
          ...
          format.html do
            ...
            #back_url = params[:error_callback].blank? ? :back : params[:error_callback]
            redirect_to params[:error_callback].blank? ? :back : params[:error_callback]
          end
        end
      end
    end
